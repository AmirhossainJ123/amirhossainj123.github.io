...
function knowledge() {
    part_1_1 = ["I"]
    part_1_2 = ["You"]
    part_1_3 = ["He","She","It","Human","Earth","Carl","Amir","The King","Apple","The Giant","Legend","Hero"]
    ...
    */
    ...
    part_3_first = ["cool","insane","amazing","dead","a beast","developer","scientist","student","an idiot","Legend","Hero","nerd","flying","eating","dying","sitting","watching","looking","searching","boring","bored","from Earth","taller","gamer","artist","stupid"] // goes for am, is, are
    part_3_second = ["had enough","been killed","coins","done your job","life","gone insane","eaten the whole ice cream","written the book","died","been lied to","been destroyed","been dreaming","seen here before","begun the challenge"] // goes for have, have, has
    part_3_third = ["to go","the opportunity","the chance","enough power","lost","begun","the keys","money","to play all night","to defeat everyone","to become the best","to recover","to start again","to do it"] // goes for had, had, had
