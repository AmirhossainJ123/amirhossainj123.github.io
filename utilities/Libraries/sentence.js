...
function knowledge() {
    ...
    */
    ...
    part_3_first =  ["cool","Assassin","Doctor","Killer","me","Robber","insane","amazing","dead","a beast","developer","scientist","student","an idiot","Legend","Hero","nerd","flying","eating","dying","sitting","watching","looking","searching","boring","bored","from Earth","taller","gamer","artist","stupid","SuperStar","kinda sus","weird","cringe","Captain","Bad","Real","Fake","Weird","Annoying","Flying","Playing Games","Cruel","unimaginably busy now"] // goes for am, is, are
    part_3_second = ["had enough","been killed","been stolen","coins","done your job","life","gone insane","eaten the whole ice cream","written the book","died","been lied to","been destroyed","been dreaming","seen here before","begun the challenge","to be murdered","to be nice","to eat dirt","to say hi","to answer me","to kill the ender dragon and free the end","to get 100 score in his exam","to stop it","to explode to pieces","to do the Unthinkable"] // goes for have, have, has
