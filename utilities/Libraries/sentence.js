...
function knowledge() {
    ...
    */
    ...
    part_3_first =  ["cool","Assassin","Doctor","Killer","me","Robber","insane","amazing","dead","a beast","developer","scientist","student","an idiot","Legend","Hero","nerd","flying","eating","dying","sitting","watching","looking","searching","boring","bored","from Earth","taller","gamer","artist","stupid","SuperStar","kinda sus","weird","cringe","Captain","Bad","Real","Fake","Broke","Annoying","Flying","Playing Games","Cruel","unimaginably busy now","Bigger","You","Lovely","Rude","freaking out right now","the problem","potato chips with extra salt and a bit of hot sauce","very stupid","Me","Us"] // goes for am, is, are
